// BASTİÇE MATEMATİK 4 İŞLEM ÖĞRETME VE SORU ÇÖZDÜRME
#include <stdio.h>
#include <stdlib.h>
#include <time.h>
...
void tebriklermesaj(int tebrikTur)
{
    ...
    {
        case 1:
            puts("Tebrikler, toplama bitti, isterseniz bide digerlerini deneyin :)");
            break;
        case 2:
            puts("Tebrikler, cikarma bitti, isterseniz bide digerlerini deneyin :)");
            break;
        case 3:
            puts("Tebrikler, carpma bitti, isterseniz bide digerlerini deneyin :)");
            break;
        case 4:
            puts("Tebrikler, bolme bitti, isterseniz bide digerlerini deneyin :)");
            break;
        default:
