// Standart veri tipleri boyutlarini belirlemek
// icin sizeof operatorunu kullanmak
#include <stdio.h>
...
int main(void)
{
    ...
    double d;
    long double ld;
    int array[20]; // 20 int elemanli dizi olustur
    int *ptr = array; // diziye isaret eden isaretci olustur
